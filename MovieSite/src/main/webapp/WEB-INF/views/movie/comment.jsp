...
<div class="container">
    ...
    <br><br>
                ...
                <table class="table">                    
                    <tr>
                        <td>
                            ...
                            <br>
                            <div>
                                <a href='#' onClick="save_comment('${movie.mseq}')" class="btn btn-info">등록</a>
                            </div>
                        </td>
                    </tr>
                </table>
        ...
        <input type="hidden" id="mseq" name="mseq" value="${movie.mseq}" />        
    </form>
</div>
<div class="container">
...
function save_comment(mseq){
	if(${loginUser==null}){
		alert("로그인이 필요합니다.");
	}else{
	$.ajax({
		type:'POST',
		url: 'movie_comment_insert',
